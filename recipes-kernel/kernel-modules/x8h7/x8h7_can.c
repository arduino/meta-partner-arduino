...
/**
 */
static void x8h7_can_hw_tx_enqueue(union x8h7_can_frame_message * x8h7_can_msg, struct can_frame *frame)
{
#ifdef DEBUG
                                       ...
                                       struct net_device *net)
{
  ...
  x8h7_can_hw_tx_enqueue(&priv->tx_frame, frame);
  priv->tx_frame_rdy = 1;
