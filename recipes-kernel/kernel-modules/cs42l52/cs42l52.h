...
#define CS42L52_MAP_INCR_BIT		0x80 /* M.P. see page 39 of the datasheet */

#define CS42L52_FIX_BITS_CTL			0x00
#define CS42L52_CHIP				(0x01 | CS42L52_MAP_INCR_BIT)
...
#define CS42L52_PWRCTL1				(0x02 | CS42L52_MAP_INCR_BIT)
...
#define CS42L52_PWRCTL2				(0x03 | CS42L52_MAP_INCR_BIT)
...
#define CS42L52_PWRCTL3				(0x04 | CS42L52_MAP_INCR_BIT)
...
#define CS42L52_CLK_CTL				(0x05 | CS42L52_MAP_INCR_BIT)
...
#define CS42L52_IFACE_CTL1			(0x06 | CS42L52_MAP_INCR_BIT)
...
#define CS42L52_IFACE_CTL2			(0x07 | CS42L52_MAP_INCR_BIT)
...
#define CS42L52_ADC_PGA_A			(0x08 | CS42L52_MAP_INCR_BIT)
#define CS42L52_ADC_PGA_B			(0x09 | CS42L52_MAP_INCR_BIT)
...
#define CS42L52_ANALOG_HPF_CTL			(0x0A | CS42L52_MAP_INCR_BIT)
#define CS42L52_HPF_CTL_ANLGSFTB		(1 << 3)
#define CS42L52_HPF_CTL_ANLGSFTA                (1 << 0)

#define CS42L52_ADC_HPF_FREQ			(0x0B | CS42L52_MAP_INCR_BIT)
#define CS42L52_ADC_MISC_CTL			(0x0C | CS42L52_MAP_INCR_BIT)
#define CS42L52_ADC_MISC_CTL_SOURCE_DSP		(1 << 6)

#define CS42L52_PB_CTL1				(0x0D | CS42L52_MAP_INCR_BIT)
...
#define	CS42L52_MICA_CTL			(0x10 | CS42L52_MAP_INCR_BIT)
#define CS42L52_MICB_CTL			(0x11 | CS42L52_MAP_INCR_BIT)
...
#define CS42L52_PGAA_CTL			(0x12 | CS42L52_MAP_INCR_BIT)
#define CS42L52_PGAB_CTL			(0x13 | CS42L52_MAP_INCR_BIT)
#define CS42L52_PGAX_CTL_VOL_12DB		24
#define CS42L52_PGAX_CTL_VOL_6DB		12 /*step size 0.5db*/

#define CS42L52_PASSTHRUA_VOL			(0x14 | CS42L52_MAP_INCR_BIT)
#define CS42L52_PASSTHRUB_VOL			(0x15 | CS42L52_MAP_INCR_BIT)

#define CS42L52_ADCA_VOL			(0x16 | CS42L52_MAP_INCR_BIT)
#define CS42L52_ADCB_VOL			(0x17 | CS42L52_MAP_INCR_BIT)
#define CS42L52_ADCX_VOL_24DB			24 /*step size 1db*/
#define CS42L52_ADCX_VOL_12DB			12
#define CS42L52_ADCX_VOL_6DB			6

#define CS42L52_ADCA_MIXER_VOL			(0x18 | CS42L52_MAP_INCR_BIT)
#define CS42L52_ADCB_MIXER_VOL			(0x19 | CS42L52_MAP_INCR_BIT)
#define CS42L52_ADC_MIXER_VOL_12DB		0x18

#define CS42L52_PCMA_MIXER_VOL			(0x1A | CS42L52_MAP_INCR_BIT)
#define CS42L52_PCMB_MIXER_VOL			(0x1B | CS42L52_MAP_INCR_BIT)

#define CS42L52_BEEP_FREQ			(0x1C | CS42L52_MAP_INCR_BIT)
#define CS42L52_BEEP_VOL			(0x1D | CS42L52_MAP_INCR_BIT)
#define CS42L52_BEEP_TONE_CTL			(0x1E | CS42L52_MAP_INCR_BIT)
#define CS42L52_BEEP_RATE_SHIFT			4
#define CS42L52_BEEP_RATE_MASK			0x0F

#define CS42L52_TONE_CTL			(0x1F | CS42L52_MAP_INCR_BIT)
#define CS42L52_BEEP_EN_MASK			0x3F

#define CS42L52_MASTERA_VOL			(0x20 | CS42L52_MAP_INCR_BIT)
#define CS42L52_MASTERB_VOL			(0x21 | CS42L52_MAP_INCR_BIT)

#define CS42L52_HPA_VOL				(0x22 | CS42L52_MAP_INCR_BIT)
#define CS42L52_HPB_VOL				(0x23 | CS42L52_MAP_INCR_BIT)
#define CS42L52_DEFAULT_HP_VOL			0xF0

#define CS42L52_SPKA_VOL			(0x24 | CS42L52_MAP_INCR_BIT)
#define CS42L52_SPKB_VOL			(0x25 | CS42L52_MAP_INCR_BIT)
#define CS42L52_DEFAULT_SPK_VOL			0xF0

#define CS42L52_ADC_PCM_MIXER			(0x26 | CS42L52_MAP_INCR_BIT)

#define CS42L52_LIMITER_CTL1			(0x27 | CS42L52_MAP_INCR_BIT)
#define CS42L52_LIMITER_CTL2			(0x28 | CS42L52_MAP_INCR_BIT)
#define CS42L52_LIMITER_AT_RATE			(0x29 | CS42L52_MAP_INCR_BIT)

#define CS42L52_ALC_CTL				(0x2A | CS42L52_MAP_INCR_BIT)
...
#define CS42L52_ALC_RATE			(0x2B | CS42L52_MAP_INCR_BIT)
#define CS42L52_ALC_SLOWEST_RELEASE		0x3F

#define CS42L52_ALC_THRESHOLD			(0x2C | CS42L52_MAP_INCR_BIT)
...
#define CS42L52_NOISE_GATE_CTL			(0x2D | CS42L52_MAP_INCR_BIT)
...
#define CS42L52_CLK_STATUS			(0x2E | CS42L52_MAP_INCR_BIT)
#define CS42L52_BATT_COMPEN			(0x2F | CS42L52_MAP_INCR_BIT)

#define CS42L52_BATT_LEVEL			(0x30 | CS42L52_MAP_INCR_BIT)
#define CS42L52_SPK_STATUS			(0x31 | CS42L52_MAP_INCR_BIT)
#define CS42L52_SPK_STATUS_PIN_SHIFT		3
#define CS42L52_SPK_STATUS_PIN_HIGH		1

#define CS42L52_TEM_CTL				(0x32 | CS42L52_MAP_INCR_BIT)
#define CS42L52_TEM_CTL_SET			0x80
#define CS42L52_THE_FOLDBACK			(0x33 | CS42L52_MAP_INCR_BIT)
#define CS42L52_CHARGE_PUMP			(0x34 | CS42L52_MAP_INCR_BIT)
...
#define CS42L52_MAX_REGISTER_MAP_INCR	(CS42L52_MAX_REGISTER | CS42L52_MAP_INCR_BIT)
