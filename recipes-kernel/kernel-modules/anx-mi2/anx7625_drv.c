...
/* set interrupt vector mask bit as platform needed  0: eable 1: disable*/
	...
	anx7625_reg_write(anx7625_ctx, anx7625_ctx->i2c.rx_p0_client,
					INTERFACE_CHANGE_INT_MASK, INT_MASK_OFF);
//#else
...
//		ReadReg(OCM_SLAVE_I2C_ADDR1, AUTO_PD_MODE) | AUTO_PD_ENABLE);
	reg = anx7625_reg_read(anx7625_ctx, anx7625_ctx->i2c.rx_p0_client,
											 AUTO_PD_MODE);
	reg |= AUTO_PD_ENABLE;
	anx7625_reg_write(anx7625_ctx, anx7625_ctx->i2c.rx_p0_client,
					AUTO_PD_MODE, reg);
